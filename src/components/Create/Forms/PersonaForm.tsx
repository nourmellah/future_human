...
function PersonaCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`relative w-full aspect-square rounded-2xl overflow-hidden border transition-shadow ${
        active ? "border-transparent" : "border-[#222]"
      }`}
